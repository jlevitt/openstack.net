namespace net.openstack.Providers.Rackspace
{
    ...
    public interface IDnsService
    {
        ...
        /// <see cref="DnsCompletionOption.RequestCompleted"/>, the job will additionally be in one of the following
        /// states.
        ///
        /// <list type="bullet">
        ...
        /// <para>-or-</para>
        /// <para>If <paramref name="completionOption"/> is not a valid <see cref="DnsCompletionOption"/>.</para>
        /// </exception>
        /// <exception cref="WebException">If the REST request does not return successfully.</exception>
        ...
        /// <exception cref="ArgumentException">
        /// If <paramref name="domainIds"/> contains any <c>null</c> or empty values.
        /// <para>-or-</para>
        /// <para>If <paramref name="completionOption"/> is not a valid <see cref="DnsCompletionOption"/>.</para>
        /// </exception>
        /// <exception cref="WebException">If the REST request does not return successfully.</exception>
        ...
        Task<Tuple<IEnumerable<DnsRecord>, int?>> ListRecordsAsync(string domainId, DnsRecordType recordType, string recordName, string recordData, int? offset, int? limit, CancellationToken cancellationToken);
