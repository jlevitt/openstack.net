namespace Net.OpenStack.Testing.Integration.Providers.Rackspace
{
    ...
    public class UserQueuesTestsSynchronous
    {
        ...
        [TestCategory(TestCategories.User)]
        [TestCategory(TestCategories.QueuesSynchronous)]
        public void TestQueueMetadataStatic()
        {
            IQueueingService provider = CreateProvider();
            string queueName = CreateRandomQueueName();
        ...
        [TestCategory(TestCategories.User)]
        [TestCategory(TestCategories.QueuesSynchronous)]
        public void TestQueueMetadataDynamic()
        {
            IQueueingService provider = CreateProvider();
            string queueName = CreateRandomQueueName();
        ...
        public void TestQueueMessages()
        {
            ...
            foreach (string queueName in responseQueueNames)
                provider.CreateQueue(queueName);
        ...
        private int PublishMessages(string requestQueueName, string replyQueueName, CancellationToken token)
        {
        ...
        private int SubscribeMessages(string requestQueueName, CancellationToken token)
        {
            IQueueingService queueingService = CreateProvider();
            int processedMessages = 0;
